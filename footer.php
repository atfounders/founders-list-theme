...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info">
			...
			<a href="http://wordpress.org/" title="<?php esc_attr_e( 'A Semantic Personal Publishing Platform', 'founders_list' ); ?>" rel="generator"><?php printf( __( 'Proudly powered by %s', 'founders_list' ), 'WordPress' ); ?></a>
			<span class="sep"> | </span>
